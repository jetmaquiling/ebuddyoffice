...
export default function Popup({state, dispatch, load, onReset, onUpdate}) {
  
  return <div className={styles.popupSection}>
      <div className={styles.descriptionContainer}>
          <Type2 dispatch={dispatch} label="Activate Popup" field="openPopup" value={state.openPopup} placeholder="OPTIONAL" />
